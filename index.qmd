...
::: {.column width="50%"}
**Why public statistics need classifications**

- Aggregating millions of businesses, jobs, or transactions requires a **shared coding system**
- Same code, same meaning across regions, sectors, time, and countries
- Without it: no harmonised GDP, no comparable industry statistics
:::
