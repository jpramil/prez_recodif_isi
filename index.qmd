...
The complexity for us relies in the fact that the correspondance between old codes and new codes can be non bijective.
...
With theses cases, let's call them multivocal, a simple look up with mapping table alone cannot tell you which one applies to a given business activity in our old training set — you need the activity description and expert judgement.
...
Two takeaways from this annotation campagne. 
...
And the campaign made the expert reasoning more explicit for us, helping us to build a consistente LLM prompt . That's the next chapter.
:::
