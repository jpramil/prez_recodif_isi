...
[A substantial share of disagreements are not LLM errors but ambiguous descriptions or legacy-coding mistakes. The codable filter is per-model, hence the dash for the ensemble vote.]{.small}
